...
class Floats1d(_Array1d, Floats):
    ...
    @overload
    def cumsum(self, *, keepdims: Tru, axis: Optional[OneAx] = None, out=Optional["Floats1d"]) -> "Floats1d": ...
    @overload # Cumsum is unusual in this
    def cumsum(self, *, keepdims: Fal, axis: Optional[OneAx]=None, out=Optional["Floats1d"]) -> "Floats1d": ...
    def cumsum(self, *, keepdims: bool=False, axis: _1_AllAx=None, out: Optional["Floats1d"]=None) -> "Floats1d": ...

    @overload
    def sum(self, *, keepdims: Tru, axis: Optional[OneAx] = None, out=Optional["Floats1d"]) -> "Floats1d": ...
    @overload
...
class Ints1d(_Array1d, Ints):
    ...
    @overload
    def cumsum(self, *, keepdims: Tru, axis: Optional[OneAx] = None, out=Optional["Ints1d"]) -> "Ints1d": ...
    @overload
    def cumsum(self, *, keepdims: Fal=False, axis: Optional[OneAx]=None, out=Optional["Ints1d"]) -> "Ints1d": ...
    def cumsum(self, *, keepdims: bool=False, axis: _1_AllAx=None, out: Optional["Ints1d"]=None) -> "Ints1d": ...

    @overload
    def sum(self, *, keepdims: Tru, axis: Optional[OneAx] = None, out=Optional["Ints1d"]) -> "Ints1d": ...
    @overload
...
class Floats2d(_Array2d, Floats):
    ...
    @overload
    def sum(self, *, keepdims: Tru, axis: _2_AllAx=None, out=Optional["Floats2d"]) -> "Floats2d": ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: OneAx, out=Optional[Floats1d]) -> Floats1d: ...
    @overload
...
class Floats3d(_Array3d, Floats):
    ...
    @overload
    def sum(self, *, keepdims: Tru, axis: _3_AllAx=None, out=Optional["Floats3d"]) -> "Floats3d": ...
    @overload
    def sum(self, *, keepdims: Fal, axis: OneAx, out=Optional[Floats2d]) -> Floats2d: ...
    @overload
    def sum(self, *, keepdims: Fal, axis: TwoAx, out=Optional[Floats1d]) -> Floats1d: ...
    @overload
...
class Ints3d(_Array3d, Ints):
    ...
    @overload
    def sum(self, *, keepdims: Tru, axis: _3_AllAx=None, out=Optional["Ints3d"]) -> "Ints3d": ...
    @overload
    def sum(self, *, keepdims: Fal, axis: OneAx, out=Optional[Ints2d]) -> Ints2d: ...
    @overload
    def sum(self, *, keepdims: Fal, axis: TwoAx, out=Optional[Ints1d]) -> Ints1d: ...
    @overload
...
class Floats4d(_Array4d, Floats):
    ...
    @overload
    def sum(self, *, keepdims: Tru, axis: _4_AllAx=None, out=Optional["Floats4d"]) -> "Floats4d": ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: OneAx, out=Optional[Floats3d]) -> Floats3d: ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: TwoAx, out=Optional[Floats2d]) -> Floats2d: ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: ThreeAx, out=Optional[Floats1d]) -> Floats1d: ...
    @overload
...
class Ints4d(_Array4d, Ints):
    ...
    @overload
    def sum(self, *, keepdims: Tru, axis: _4_AllAx=None, out=Optional["Ints4d"]) -> "Ints4d": ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: OneAx, out=Optional[Ints3d]) -> Ints3d: ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: TwoAx, out=Optional[Floats2d]) -> Ints2d: ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: ThreeAx, out=Optional[Ints1d]) -> Ints1d: ...
    @overload
    def sum(self, *, keepdims: Fal=False, axis: Optional[FourAx], out=None) -> int: ...
    def sum(self, *, keepdims: bool=False, axis: _4_AllAx=None, out: Union[None, Ints1d, Ints2d, Ints3d, "Ints4d"]=None) -> _4I_ReduceResults: ...
