...
def _get_moments(ops, X):
    ...
    # TODO: This is wrong! We should be normalizing by shape[1], not shape[0]!
    # However fixing this will invalidate the pre-trained models, so we'd better
    # wait until the next major version.
